...
public final class AddressbookRunner {
    private final static Logger logger = Logger.getLogger(AddressbookRunner.class.getName());
    static final long WAIT_TIME_AFTER_EVENT = 500;
    static final long WAIT_TIME_AFTER_RELOAD = 500;
    public static final String URL = "http://localhost/addressbook-mod/addressbook/";
...
//        builder.setStateVertexFactory(new PDiffStateVertexFactory(0.20080));
        ...
        File customOutput = new File("out" + File.separator + "addressbook-withinapp-dom2vec-new-correct");
