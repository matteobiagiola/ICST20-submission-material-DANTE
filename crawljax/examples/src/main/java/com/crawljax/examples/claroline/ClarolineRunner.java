...
/**
 * Crawljax runner for the Claroline web application. The crawl will produce
 * output using the {@link CrawlOverview} plugin.
 */
public final class ClarolineRunner {
    private final static Logger logger = Logger.getLogger(ClarolineRunner.class.getName());

    static final long WAIT_TIME_AFTER_EVENT = 500;
    static final long WAIT_TIME_AFTER_RELOAD = 500;

    public static final String URL = "http://localhost/claroline-1.11.10/index.php";
    static final long MAX_RUNTIME = 30;  // minutes
...
//        builder.setStateVertexFactory(new RTEDStateVertexFactory(0.04099));
        ...
        File customOutput = new File("out" + File.separator + "claroline-withinapp-pdiff-30mins");
