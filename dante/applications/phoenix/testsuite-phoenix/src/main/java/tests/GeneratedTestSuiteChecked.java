...
public class GeneratedTestSuiteChecked {
	...
	public void test02() throws Exception {
		...
		Thread.sleep(550);
		driver.findElement(
				By.xpath("/HTML[1]/BODY/MAIN[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]"))
				.click();
		Thread.sleep(550);
		driver.findElement(
				By.xpath("/HTML[1]/BODY/MAIN[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[2]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/TEXTAREA[1]"))
	...
	public void test07() throws Exception {
		...
		Thread.sleep(550);
		driver.findElement(
				By.xpath("/HTML[1]/BODY/MAIN[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[6]/DIV[1]"))
				.click();
		Thread.sleep(550);
		driver.findElement(By.id("list_name")).clear();
		driver.findElement(By.id("list_name")).sendKeys("updated new list");
