...
function setCoverageReportDirectoryPath() {
    local application_name_local=$1
    local coverage_reports_directory_path_local="$HOME/workspace/ICST20-submission-material-DANTE/dante/applications/$application_name_local/testsuite-$application_name_local/coverage-reports"
	if [[ $os == "Darwin" ]]; then
