...
if test $# -lt 3 ; then echo 'ARGS: application_name (petclinic|splittypie|retroboard|phoenix|dimeshift|ecommerce|pagekit), headless (true|false) crawling_max_runtime (number representing crawling minutes)' ; exit 1 ; fi
